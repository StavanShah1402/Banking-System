       ...
       <div class="table-responsive-sm">
         <table class="table table-hover table-condensed table-bordered table-light" >
           <thead class="bg-secondary" style="color:white;">
             <tr>
               <th class="text-center" style="background-color:#301922;">S.num</th>
               <th class="text-center" style="background-color:#301922;">Sender</th>
               <th class="text-center" style="background-color:#301922;">Receiver</th>
               <th class="text-center" style="background-color:#301922;">Balance</th>
               <th class="text-center" style="background-color:#301922;">Date & Time</th>
             </tr>
           </thead>
